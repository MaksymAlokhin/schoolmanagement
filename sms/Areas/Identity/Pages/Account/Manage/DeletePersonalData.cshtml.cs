...
namespace sms.Areas.Identity.Pages.Account.Manage
{
    public class DeletePersonalDataModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (!result.Succeeded)
            {
                throw new InvalidOperationException($"Неочікувана помилка сталась при видалені користувача з ID '{userId}'.");
            }

            await _signInManager.SignOutAsync();

            _logger.LogInformation("Користувач з ID '{UserId}' видалив свій обліковий запис.", userId);
