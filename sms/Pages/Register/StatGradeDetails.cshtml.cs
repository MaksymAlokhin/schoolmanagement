...
namespace sms.Pages.Register
{
    ...
    public class StatGradeDetailsModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync(string sortOrder, int gradeId, int year = 2021, int semester = 1, int? pageIndex = 1)
        {
            ...
            Log.Information("Користувач переглядає сторінку {0} статистичних даних по класу", pageIndex ?? 1);
