...
namespace sms.Pages.Register
{
    ...
    public class StatSubjectDetailsModel : PageModel
    {
        public StatSubjectDetailsModel(sms.Data.ApplicationDbContext context, IConfiguration configuration)
        {
            _context = context;
        ...
        public void OnGetAsync(int subjectId, string sortOrder, int year = 0, int semester = 1, int? pageIndex = 1)
        {
            subjectName = _context.Subjects.Find(subjectId).Name;
            ...
            //Генерація даних для таблиці успішності по предмету
        ...
        public JsonResult OnPostData(int subjectId, int year, int semester)
        {
            //Select time period
            //Вибір часового проміжку
    ...
    //Data structure for academic performance in a subject by grade
    //Структура даних для діагарми та таблиці успішності по предмету у різних класах
    public class StatSubjectDetails
    {
